...
_TRAJ_TYPE_MAP: dict[str, str] = {
    ...
    "molotov": "molotov",           "cmolotovprojectile":    "molotov",
    "molotovgrenade": "molotov",
    "incendiarygrenade": "incendiary", "cincendiaryprojectile": "incendiary",
    "incendiary": "incendiary",
    "decoygrenade": "decoy",        "cdecoyprojectile":      "decoy",
    "decoy": "decoy",               "cdecoyprojector":       "decoy",
}
...
def _extract_grenades(parser, rounds: list[RoundInfo]) -> list[GrenadeEvent]:
    ...
    try:
        ...
        for row in _rows(traj_df):
            ...
            try:
                thrower_id = (
                    0 if raw_sid is None
                    or (isinstance(raw_sid, float) and math.isnan(raw_sid))
